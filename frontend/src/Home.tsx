                    ...
                    <DesContainer>
                        <NFT elevation={3}>
                            ...
                            <div style={{
                                ...
                                <h6 style={{width: 400, textAlign: 'center'}}>Mint Button Will Still Appear After
                                    Whitelist Tokens are Depleted. Attempting to mint after White List tokens are gone
                                    will result in a .01 SOL bot tax.</h6>
                            </div>
                            <MintButtonContainer>
                                    ...
                                    !wallet ? (
                                        ...
                                        wallet.signTransaction ? (
                                            <GatewayProvider
                                                ...
                                                // gatekeeperNetwork={candy_machine.state.gatekeeper_network}
                                                gatekeeperNetwork={
